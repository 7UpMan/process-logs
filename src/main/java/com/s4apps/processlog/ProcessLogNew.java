 ...
 * @author mat
 */
public class ProcessLogNew {
    
    private static final Logger logger = Logger.getLogger(ProcessLogNew.class.getName());
     ...
     */
    public ProcessLogNew(CliOptions options, ConfigData config) {
        if (options == null) {
    ...
    public static void main(String[] args) {
        ...
        ProcessLogNew processor = new ProcessLogNew(options, config);
        processor.run();
    }
